...
## 5. دعم اللغات الثلاث (العربية، الفرنسية، الإسبانية) وواجهات RTL/LTR
- النظام ثلاثي اللغات معتمد دولياً: العربية (RTL هي الأساسية)، الفرنسية (LTR)، والإسبانية (LTR) لدعم عمليات النقل واللوجستيك الدولي مع إسبانيا وأوروبا.
- التعامل مع اللغة الإسبانية كشريك ومواطن لغوي من الدرجة الأولى متكافئ تماماً مع العربية والفرنسية في كافة الواجهات، الجداول، المودالات، بوابات العملاء، وحفظ تفضيلات المستخدمين.
- استخدم فئات Tailwind التوافقية مع الاتجاهين: `ms-*` و `me-*`، `ps-*` و `pe-*`.
- احرص دائماً على إضافة وتحديث مفاتيح الترجمة بالتساوي عبر الملفات الثلاثة: `src/i18n/messages/ar.json` و `fr.json` و `es.json`.
