...
export function ThemeToggle({ className = '' }: { className?: string }) {
  ...
  return (
    <Button
      ...
      title={theme === 'dark' ? t('تفعيل الوضع الفاتح', 'Activer le mode clair', 'Activar modo claro') : t('تفعيل الوضع الداكن', 'Activer le mode sombre', 'Activar modo oscuro')}
    >
      ...
      <span className="sr-only">{t('تبديل المظهر', 'Changer de thème', 'Cambiar tema')}</span>
    </Button>
  );
}
